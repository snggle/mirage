...
class TrezorEIP1559SignatureRequest extends ATrezorInboundRequest {
  ...
  factory TrezorEIP1559SignatureRequest.fromDto(EthSignTx ethSignTx) {
    EthereumEIP1559Transaction ethereumEIP1559Transaction = EthereumEIP1559Transaction(
      ...
      nonce: _hexToBigInt(ethSignTx.transaction.nonce),
      maxPriorityFeePerGas: _hexToBigInt(ethSignTx.transaction.maxPriorityFeePerGas),
      maxFeePerGas: _hexToBigInt(ethSignTx.transaction.maxFeePerGas),
      gasLimit: _hexToBigInt(ethSignTx.transaction.gasLimit),
      to: ethSignTx.transaction.to,
      value: _hexToBigInt(ethSignTx.transaction.value),
