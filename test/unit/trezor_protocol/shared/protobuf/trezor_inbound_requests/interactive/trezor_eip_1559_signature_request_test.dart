...
void main() {
  group('Tests of TrezorEIP1559SignatureRequest.askForSupplementaryInfo()', () {
    ...
    test('Should [return TrezorAskToWaitResponse] if [data is COMPLETE] (8 bytes, dataLength = 8)', () async {
      // Arrange
      TrezorEIP1559SignatureRequest actualTrezorEIP1559SignatureRequest = TrezorEIP1559SignatureRequest(
        waitingAgreedBool: false,
        ethereumEIP1559Transaction: cryptography_utils.EthereumEIP1559Transaction(
          ...
          to: '479b2970f03f9021cff00b6e5807ba544ea351f8',
          value: BigInt.from(10000000000000000),
          data: Uint8List.fromList(<int>[1, 1, 1, 1, 1, 1, 1, 1]),
          accessList: const <cryptography_utils.AccessListBytesItem>[],
        ),
        dataLength: 8,
        derivationPath: const <int>[2147483692, 2147483708, 2147483648, 0, 0],
      ...
      // Assert
      TrezorAskToWaitResponse expectedTrezorOutboundResponse = TrezorAskToWaitResponse.eip1559Signature();

      expect(actualTrezorOutboundResponse, expectedTrezorOutboundResponse);
    });
  });

  group('Tests of TrezorEIP1559SignatureRequest.fillWithAnotherRequest()', () {
    test('Should [fill the data parameter] when given an ATrezorSupplementaryRequest', () async {
      // Arrange
      TrezorEIP1559SignatureRequest actualTrezorEIP1559SignatureRequest = TrezorEIP1559SignatureRequest(
        waitingAgreedBool: false,
        ethereumEIP1559Transaction: cryptography_utils.EthereumEIP1559Transaction(
      ...
      TrezorWaitForResponseAgreement trezorWaitForResponseAgreement = TrezorWaitForResponseAgreement();

      // Act
      actualTrezorEIP1559SignatureRequest = actualTrezorEIP1559SignatureRequest.fillWithAnotherRequest(trezorTxDataSupply);
      ...
      // Act
      actualTrezorEIP1559SignatureRequest = actualTrezorEIP1559SignatureRequest.fillWithAnotherRequest(trezorWaitForResponseAgreement);

      // Assert
      expectedTrezorEIP1559SignatureRequest = TrezorEIP1559SignatureRequest(
      ...
      TestUtils.printInfo('Should [change waitingAgreedBool to true] when given TrezorWaitForResponseAgreement');
      expect(actualTrezorEIP1559SignatureRequest, expectedTrezorEIP1559SignatureRequest);
    });
  });

  group('Tests of TrezorEIP1559SignatureRequest.requestReadyBool()', () {
    test('Should [return false] if [data is NOT COMPLETE] (8 bytes, dataLength = 16) and [waitingAgreedBool == false]', () async {
      // Arrange
      TrezorEIP1559SignatureRequest actualTrezorEIP1559SignatureRequest = TrezorEIP1559SignatureRequest(
        waitingAgreedBool: false,
        ethereumEIP1559Transaction: cryptography_utils.EthereumEIP1559Transaction(
      ...
      // Act
      bool actualRequestReadyBool = actualTrezorEIP1559SignatureRequest.requestReadyBool;
    ...
    test('Should [return false] if [data is COMPLETE] (16 bytes, dataLength = 16) and [waitingAgreedBool == false]', () async {
      // Arrange
      TrezorEIP1559SignatureRequest actualTrezorEIP1559SignatureRequest = TrezorEIP1559SignatureRequest(
        waitingAgreedBool: false,
        ethereumEIP1559Transaction: cryptography_utils.EthereumEIP1559Transaction(
    ...
    test('Should [return true] if [data is COMPLETE] (16 bytes, dataLength = 16) and [waitingAgreedBool == true]', () async {
      // Arrange
      TrezorEIP1559SignatureRequest actualTrezorEIP1559SignatureRequest = TrezorEIP1559SignatureRequest(
        waitingAgreedBool: true,
        ethereumEIP1559Transaction: cryptography_utils.EthereumEIP1559Transaction(
