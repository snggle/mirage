...
void main() {
  initLocator();
  TrezorPbCommunicationNotifier actualTrezorPbCommunicationNotifier = globalLocator<TrezorPbCommunicationNotifier>();

  group('Tests of ProtobufController.getResponseBuffer()', () {
    test('Should [return Features buffer] with [FILLED sessionId], if input starts with 0000 and [sessionId EXISTS] (Initialize -> Features)',
        () async {
      // Arrange
      ...
      // Act
      String actualOutputBuffer = await actualTrezorPbCommunicationNotifier.getResponseBuffer(actualInputBuffer);

      // Assert
      // Buffer for [Features]
      String expectedOutputBuffer =
          '';

      expect(actualOutputBuffer, expectedOutputBuffer);
    });

    test('Should [return Features buffer] with [RANDOM sessionId] if input starts with 0000 [sessionId NOT EXISTS] (Initialize -> Features)',
        () async {
      // Arrange
      // Buffer for [Initialize]
      ...
      // Buffer for [Features]
      String expectedOutputBuffer =
          '';
    ...
    test('Should [return Features buffer] with [EMPTY sessionId] if input starts with 0037 (GetFeatures -> Features)', () async {
      ...
      // Buffer for [Features]
      String expectedOutputBuffer =
          '';
    ...
    test('Should [return EthereumTxRequest] with [dataLength = 512] if inputMsg is EthereumSignTxEIP1559 with dataLength = 1536', () async {
      ...
      // Act
      String actualResponseBuffer = await actualTrezorPbCommunicationNotifier.getResponseBuffer(actualInputBuffer);
